...
user in an INI file next to McAfeeStingerPortable.exe called McAfeeStingerPortable.ini.
...
copy AppNamePortable.ini from this directory to McAfeeStingerPortable.ini next to
McAfeeStingerPortable.exe. The options in the INI file are as follows:
